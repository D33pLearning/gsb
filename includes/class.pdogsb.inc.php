...
class PdoGsb
{
    ...
    {	
        $requetePrepare = PdoGsb::$monPdo->prepare(
            ...
            . 'visiteur.prenom AS prenom, visiteur.estComptable AS estComptable '
            . 'FROM visiteur '
			. 'WHERE visiteur.estComptable = 0'
        );
    ...
    {
		// estComptable = 0 --> visiteur
		
        $requetePrepare = PdoGsb::$monPdo->prepare(
            'SELECT visiteur.id AS id, visiteur.nom AS nom, '
            . 'visiteur.prenom AS prenom, visiteur.estComptable AS estComptable '
            . 'FROM visiteur '
            . 'WHERE visiteur.login = :unLogin AND visiteur.mdp = :unMdp AND estComptable = 0'
        );
    ...
    {
		// estComptable = 1 --> comptable
		
        $requetePrepare = PdoGsb::$monPdo->prepare(
            'SELECT visiteur.id AS id, visiteur.nom AS nom, '
            . 'visiteur.prenom AS prenom, visiteur.estComptable AS estComptable '
            . 'FROM visiteur '
            . 'WHERE visiteur.login = :unLogin AND visiteur.mdp = :unMdp AND estComptable = 1'
        );
        $requetePrepare->bindParam(':unLogin', $login, PDO::PARAM_STR);
        $requetePrepare->bindParam(':unMdp', $mdp, PDO::PARAM_STR);
        $requetePrepare->execute();
     ...
     */
     ...
     public function majFraisHFRefuse($idFrais)
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
